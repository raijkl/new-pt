...
<nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-3">
        @include('layouts.navbars.auth.topnav', ['title' => 'Approval Decline by Gateway and PM'])
            ...
            <div class="card">
                ...
                <table class="table table-flush" id="datatable-search">
                    <thead class="thead-light">
                        <tr>
                            <th class="col text-wrap">Gateway</th>
                            <th class="col text-wrap">Total Volume</th>
                            <th class="col text-wrap">Total Trx</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold text-uppercase">East Payment </span>
                            </td>
