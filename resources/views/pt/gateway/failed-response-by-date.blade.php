...
<nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-3">
        @include('layouts.navbars.auth.topnav', ['title' => 'Gateway Failed Responses By Date'])
            ...
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex align-items-center ms-2 me-2">
                                ...
                                <select class="form-select form-control me-2" aria-label="trx capability status" style="width: 200px;">
                                    <option selected>Card Type</option>
                                    <option value="active">Select Gateway </option>
                                ...
                                <input type="date" class="form-control me-2" placeholder="" aria-label="Domain" style="width: 200px;">
                                <select class="form-select form-control me-2" aria-label="trx capability status" style="width: 200px;">
                                    <option selected>Currency</option>
                                    <option value="active">Currency </option>
                                    <option value="inactive">Test 2</option>
                                    <option value="inactive">Test 3</option>
                                </select>
                ...
                <table class="table table-flush" id="datatable-search">
                    <thead class="thead-light">
                        <tr>
                            <th class="col text-wrap">Partner Domain</th>
                            <th class="col text-wrap">Total Volume</th>
                            <th class="col text-wrap">Total Trx Count</th>
                            <th class="col text-wrap">Aprroval by Volume</th>
                            <th class="col text-wrap">Approval Trx Count</th>
                            <th class="col text-wrap">Decline by Volume</th>
                            <th class="col text-wrap">Decline by Trx Count</th>
                            <th class="col text-wrap">Approval Ratio by Volume</th>
                            <th class="col text-wrap">Approval Ratio by Trx Count</th>
                            <th class="col text-wrap">Decline Ratio by Volume  </th>
                            <th class="col text-wrap">Decline Ratio by Trx Count</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                                                        <!-- ISO -->
                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold text-uppercase">VISA</span>
                            </td>

                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">USD 20,446.23</span>
                            </td>

                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">224	</span>
                            </td>

                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">USD 1,847.77		</span>
                            </td>
                            
                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">177	</span>
                            </td>

                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">9.04%	</span>
                            </td>

                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">20.98%</span>
                            </td>

                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">0.00	</span>
                            </td>
                        ...
                        <tr>
                                                        <!-- ISO -->
                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">reddogcasino.com	</span>
                            </td>
                            ...
                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">0.00	</span>
                                                ...
                                                <tr>
                                                        <!-- ISO -->
                            <td class="col text-wrap">
                                <span class="text-xs font-weight-bold">mstreethost.com</span>
                            </td>
