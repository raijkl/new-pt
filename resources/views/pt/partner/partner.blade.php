                ...
                <table class="table table-flush" id="datatable-search">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <!-- ISO -->
                            <td>
                                <span class="text-xs font-weight-bold text-uppercase">ISO CAPS TEXT</span>
                            </td>

                            <!-- Sub ISO -->
                            <td>
                                <span class="text-xs font-weight-bold">Sub ISO Text</span>
                            </td>
                            ...
                            <!-- Gateways -->
                            <td>
                                <span class="text-xs font-weight-bold">Gateway Name</span>
                            </td>
